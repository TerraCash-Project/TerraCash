...
// Repair parameters
const QString TERRACASHWALLET("-terracashwallet");
                                          ...
                                          banTableContextMenu(0)
{
    ...
    connect(ui->btn_terracashwallet, SIGNAL(clicked()), this, SLOT(walletTerraCash()));
...
/** Restart wallet with "-terracashwallet" */
void RPCConsole::walletTerraCash()
{
    buildParameterlist(TERRACASHWALLET);
}
...
void RPCConsole::buildParameterlist(QString arg)
{
    ...
    args.removeAll(TERRACASHWALLET);
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the TerraCash RPC console.") + "<br>" +

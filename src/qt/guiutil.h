...
/** Utility functions used by the TerraCash Qt UI.
 */
namespace GUIUtil
{
...
// Render TRCH addresses in monospace font
...
// Parse "terracash:" URI into recipient object, return true on successful parsing

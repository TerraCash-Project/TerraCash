...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("TerraCash Core"),
     ...
     * override -datadir in the terracash.conf file in the default data directory
     * (to be consistent with terracashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

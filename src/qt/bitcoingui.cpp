                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("TerraCash Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a TRCH address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and terracash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About TerraCash Core"), this);
    aboutAction->setStatusTip(tr("Show information about TerraCash Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for TerraCash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your TRCH addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified TRCH addresses"));
    ...
    openAction->setStatusTip(tr("Open a terracash: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the TerraCash Core help message to get a list with possible TerraCash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("TerraCash Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to TerraCash network", "", count));
}
...
{
    QString strTitle = tr("TerraCash Core"); // default title

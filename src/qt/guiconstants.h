...
/* TerraCash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "TerraCash"
#define QAPP_ORG_DOMAIN "terracashexchange.com"
#define QAPP_APP_NAME_DEFAULT "TerraCash-Qt"
#define QAPP_APP_NAME_TESTNET "TerraCash-Qt-testnet"

...
#if defined(NDEBUG)
#error "TerraCash cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uTerraCash) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
    ...
    /* block rewards. */
         ...
         if (nHeight >=       1 && nHeight <=    1000) {nSubsidy =    1000.00 * COIN;}
    else if (nHeight >=    1001 && nHeight <=    2000) {nSubsidy =       0.00 * COIN;}
    else if (nHeight >=    2001 && nHeight <=   50000) {nSubsidy =       6.00 * COIN;}
    else if (nHeight >=   50001 && nHeight <=  100000) {nSubsidy =       5.50 * COIN;}
    else if (nHeight >=  100001 && nHeight <=  200000) {nSubsidy =       5.00 * COIN;}
    else if (nHeight >=  200001 && nHeight <=  300000) {nSubsidy =       4.50 * COIN;}
    else if (nHeight >=  300001 && nHeight <=  400000) {nSubsidy =       4.00 * COIN;}
    else if (nHeight >=  400001 && nHeight <=  500000) {nSubsidy =       3.50 * COIN;}
    else if (nHeight >=  500001 && nHeight <=  750000) {nSubsidy =       3.00 * COIN;}
    else if (nHeight >=  750001 && nHeight <= 1000000) {nSubsidy =       2.50 * COIN;}
    else if (nHeight >= 1000001 && nHeight <= 2500000) {nSubsidy =       2.00 * COIN;}
    else if (nHeight >= 2500001 && nHeight <= 5000000) {nSubsidy =       1.50 * COIN;}
    else if (nHeight >= 5000001 )                      {nSubsidy =       1.00 * COIN;}
...
int64_t GetMasternodePayment(int nHeight, int64_t blockValue, int nMasternodeCount)
{
    ...
    else if (nHeight >=    2001 && nHeight <=   50000)  {nSubsidy = blockValue * 0.80;}
    else if (nHeight >=   50001 && nHeight <=  100000)  {nSubsidy = blockValue * 0.78;}
    else if (nHeight >=  100001 && nHeight <=  200000)  {nSubsidy = blockValue * 0.76;}
    else if (nHeight >=  200001 && nHeight <=  300000)  {nSubsidy = blockValue * 0.74;}
    else if (nHeight >=  300001 && nHeight <=  400000)  {nSubsidy = blockValue * 0.72;}
    else if (nHeight >=  400001 && nHeight <=  500000)  {nSubsidy = blockValue * 0.70;}
    else if (nHeight >=  500001 && nHeight <=  750000)  {nSubsidy = blockValue * 0.68;}
    else if (nHeight >=  750001 && nHeight <= 1000000)  {nSubsidy = blockValue * 0.66;}
    else if (nHeight >= 1000001 && nHeight <= 2500000)  {nSubsidy = blockValue * 0.64;}
    else if (nHeight >= 2500001 && nHeight <= 5000000)  {nSubsidy = blockValue * 0.62;}
    else if (nHeight >= 5000001 )                       {nSubsidy = blockValue * 0.60;}
...
{
    RenameThread("terracash-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // TERRACASH: We use certain sporks during IBD, so check to see if they are
        ...
        vector<CInv> vInvWait;
        {
            ...
            BOOST_FOREACH (const CInv& inv, pto->vInventoryToSend) {
                ...
                if (inv.type == MSG_TX && !fSendTrickle) {
                    // 1/4 of tx invs terracash to all immediately
                    static uint256 hashSalt;
                    if (hashSalt == 0)
                        hashSalt = GetRandHash();

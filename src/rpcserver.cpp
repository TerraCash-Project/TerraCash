...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop TerraCash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "TerraCash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* TerraCash features */
        {"terracash", "masternode", &masternode, true, true, false},
        {"terracash", "listmasternodes", &listmasternodes, true, true, false},
        {"terracash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"terracash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"terracash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"terracash", "masternodedebug", &masternodedebug, true, true, false},
        {"terracash", "startmasternode", &startmasternode, true, true, false},
        {"terracash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"terracash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"terracash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"terracash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"terracash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"terracash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"terracash", "mnbudget", &mnbudget, true, true, false},
        {"terracash", "preparebudget", &preparebudget, true, true, false},
        {"terracash", "submitbudget", &submitbudget, true, true, false},
        {"terracash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"terracash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"terracash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"terracash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"terracash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"terracash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"terracash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"terracash", "checkbudgets", &checkbudgets, true, true, false},
        {"terracash", "mnsync", &mnsync, true, true, false},
        {"terracash", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> terracash-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:40008/\n";
}

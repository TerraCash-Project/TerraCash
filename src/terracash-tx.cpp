...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("TerraCash Core terracash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  terracash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded terracash transaction") + "\n" +
                               "  terracash-tx [options] -create [commands]   " + _("Create hex-encoded terracash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded terracash transaction

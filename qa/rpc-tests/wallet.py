...
#   c) node1 mines 32 blocks, so now node 0 has 500000TRCH, node 1 has 4250TRCH, node2 has none.
#   d) node0 sends 601 TRCH to node2, in two transactions (301 TRCH, then 300 TRCH).

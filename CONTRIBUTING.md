Contributing to TerraCash Core
==================================

The TerraCash Core project operates an open contributor model where anyone is
...
The following applies to code changes to the TerraCash Core project, and is not to be
confused with overall TerraCash Network Protocol consensus changes.

Whether a pull request is merged into TerraCash Core rests with the project merge
...
Patches that change TerraCash consensus rules are considerably more involved than
...
Where a patch set proposes to change the TerraCash consensus, it must have been
...
The project leader is the release manager for each TerraCash Core release.

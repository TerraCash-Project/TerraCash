...
SOURCES += src/activemasternode.cpp \
           ...
           src/core_write.cpp \
           src/crypter.cpp \
           src/terracash-cli.cpp \
           src/terracash-tx.cpp \
           src/terracash.cpp \
           src/db.cpp \
           ...
           src/qt/terracash.cpp \
           src/qt/terracashstrings.cpp \
...
RESOURCES += src/qt/terracash.qrc src/qt/terracash_locale.qrc

TRANSLATIONS += src/qt/locale/terracash_bg.ts \
                src/qt/locale/terracash_de.ts \
                src/qt/locale/terracash_en.ts \
                src/qt/locale/terracash_es.ts \
                src/qt/locale/terracash_fi.ts \
                src/qt/locale/terracash_fr.ts \
                src/qt/locale/terracash_it.ts \
                src/qt/locale/terracash_ja.ts \
                src/qt/locale/terracash_pl.ts \
                src/qt/locale/terracash_pt.ts \
                src/qt/locale/terracash_ru.ts \
                src/qt/locale/terracash_sk.ts \
                src/qt/locale/terracash_sv.ts \
                src/qt/locale/terracash_vi.ts \
                src/qt/locale/terracash_zh_CN.ts \
                src/qt/locale/terracash_zh_TW.ts

...
In order to support loading of multiple wallets in terracash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is terracash.cpp.
...
Changes to terracash.cpp
----------------------
terracash.cpp is the entry point into terracash-qt, and as such, will require some minor modifications to provide hooks for
